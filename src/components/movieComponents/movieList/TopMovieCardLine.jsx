...
{<div className=' justify-items-center  '>
 ...
 <div class="relative px-3   ">
   <div class="bg-white p-2 rounded-lg shadow-lg">
    ...
    <h4 class=" text-sm font-semibold uppercase leading-tight ">  <p className="  text-center h-20">{movies.name}{movies.title}</p></h4>
  ...
  <div class="mt-1">                   
    ...
    <span class="text-teal-600 text-md font-semibold"> rating: {movies.vote_average} </span>
  </div>  
  </div>
 </div>
