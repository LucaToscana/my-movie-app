...
const CreditMovieCardLine = ({ movies, dataType }) => {
...
{<div className=' justify-items-center  '>
                        <div className="w-full h-48 rounded-2xl  p-1 	">     <Link
                            to={{
 ...
 <div class="relative px-3 mt-3  ">
   <div class="bg-white py-3  px-3 rounded-lg shadow-lg">
    <div class="flex ">
    ...
    <p className="underline decoration-blue-500  text-xs 	 text-center h-2">{dataType }</p>

      <p className=" text-xs font-semibold uppercase leading-tight	 text-center h-10">{movies.name}{movies.title} </p>
 
  <div class="mt-1">
 {/* <span class="text-gray-600 text-sm"> {movies.first_air_date !== undefined ?"year:  "+ movies.first_air_date.substring(0, 4) :null}
                            {movies.release_date !== undefined ?"year:  "+  movies.release_date.substring(0, 4):null}
    </span>
    */
    }
  </div>
...
export default CreditMovieCardLine;